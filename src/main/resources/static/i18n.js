(() => {
  ...
  const translations = {
    "pt-BR": {
      ...
      "title.sbc_set": "FODDR | Detalhes do SBC",
      ...
      "sbc.card_open": "Abrir detalhes do SBC",
      "sbc.card_open_named": "Abrir detalhes do SBC {name}",
      ...
      "sbc.no_sets_in_category": "Nenhum SBC disponível nesta categoria.",
      "set.heading": "Detalhes do SBC",
      "set.subtitle_loading": "Carregando informações…",
      "set.back_catalog": "← Voltar ao catálogo",
      "set.loading_details": "Carregando detalhes do SBC",
      "set.resolve_title": "Resolver este SBC",
      "set.resolve_desc": "Informe sua forragem disponível e resolva automaticamente os desafios deste SBC.",
      "set.resolve_button": "Resolver SBX",
      "set.status_default": "Informe a forragem e clique em \"Resolver SBC\".",
      "set.results_prompt": "Informe a forragem acima e clique em \"Resolver SBC\" para ver as soluções.",
      ...
      "set.challenge_completed": "Já concluído",
    ...
    "en-US": {
      ...
      "title.sbc_set": "FODDR | SBC Details",
      ...
      "sbc.card_open": "Open SBC details",
      "sbc.card_open_named": "Open SBC details for {name}",
      "sbc.card_untitled": "Untitled SBC",
      "sbc.card_set_id": "Set ID: ",
      ...
      "sbc.no_sets_in_category": "No SBC available in this category.",
      "set.heading": "SBC details",
      "set.subtitle_loading": "Loading information…",
      "set.back_catalog": "← Back to catalog",
      "set.loading_details": "Loading SBC details…",
      "set.resolve_title": "Solve this SBC",
      "set.resolve_desc": "Enter your available fodder and automatically solve this SBC's challenges.",
      "set.resolve_button": "Solve SBC",
      "set.status_default": "Enter fodder and click \"Solve SBX\".",
      "set.results_prompt": "Enter the fodder above and click \"Solve SBC\" to see the solutions.",
      "set.meta_set_id": "Set ID: ",
      ...
      "set.no_challenges": "No challenge found for this SBC.",
      "set.not_informed": "SBC not provided.",
      "set.not_informed_detail": "Set not provided. Go back to the catalog and select a set.",
      "set.resolved": "SBC solved! {count} squad(s) found.",
      ...
      "set.resolving": "Solving SBC...",
      "set.resolve_error_retry": "Couldn't solve the SBX right now. Please try again.",
      "set.resolve_error": "Error solving SBC.",
      ...
      "set.challenge_completed": "Already completed",
